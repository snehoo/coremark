...
function page(r){const m=r>=4?{e:'🎉',h:'Thanks so much!',s:"Really glad it's hitting the mark."}:r===3?{e:'👍',h:'Thanks for letting us know',s:'Email support@coremark.study with suggestions.'}:{e:'💬',h:'Thanks for the feedback',s:'Sorry it didn\'t land. Email support@coremark.study.'};
